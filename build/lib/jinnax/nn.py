...
#Demo video for 1D PINN
#Plot results for d = 1
def demo_pinn1D(test_data,file_name,at_each = 100,times = 5,d2 = True,file_name_save = 'result_pinn_demo',title = '',framerate = 10):
    """
    ...
    with alive_bar(epochs) as bar:
        for e in range(epochs):
            ...
            bar()
    #Create demo video
    os.system('ffmpeg -framerate ' + framerate + ' -i ' + file_name_save + '/' + '%00d_slices.png -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p ' + file_name_save + '/' + file_name_save + 'slices_.mp4')
    if d2:
        os.system('ffmpeg -framerate ' + framerate + ' -i ' + file_name_save + '/' + '%00d_2d.png -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p ' + file_name_save + '/' + file_name_save + '2d_.mp4')
